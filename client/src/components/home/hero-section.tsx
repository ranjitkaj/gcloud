...
const slides = [
  ...
  },
  {
    ...
    title: "Fast Sales for Sellers, Best Deals for Buyers!",
    subtitleWords: [
      "Commercial Spaces at Great Deals",
      "Trusted Real Estate Projects Near You",
    ],
  ...
  },
  {
    ...
    title: "Fast Sales for Sellers, Best Deals for Buyers!",
    subtitleWords: [
      "Verified and Secure Plots",
      "Urgent Property Sales—Huge Discounts",
    ],
  ...
  },
  {
    ...
    title: "Fast Sales for Sellers, Best Deals for Buyers!",
    subtitleWords: [
      "Discounted Properties Ready to Sell",
      "Exclusive Offers – Maximum Savings",
    ],
