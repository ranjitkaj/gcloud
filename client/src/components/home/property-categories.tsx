...
export default function PropertyCategories() {
  ...
  const propertyCategories: PropertyTypeCount[] = [
    ...
    { 
      type: 'house', 
      count: 876, 
      image: 'https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80' 
    },
    { 
      type: 'villa', 
      count: 543, 
    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl font-bold font-heading text-gray-900 mb-2">Browse by Property Type</h2>
            <p className="text-gray-600">Find the perfect property that fits your needs</p>
          </div>
        </div>
            ...
            >
              <div className="bg-gray-50 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
                <div className="relative pb-[75%]">
                  <img 
                    src={category.image} 
                    alt={category.type.charAt(0).toUpperCase() + category.type.slice(1)} 
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">{category.count} Properties</p>
                </div>
              </div>
            </Link>
          ))}
