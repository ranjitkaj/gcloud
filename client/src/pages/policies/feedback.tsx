          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">
                We value your opinion and would love to hear from you. Please fill out the form below to share your thoughts, suggestions, or report issues.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-medium text-gray-700">Visit Our Office</h4>
                  <p className="text-gray-600">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <h4 className="font-medium text-gray-700 mb-2">We Value Your Input</h4>
                <p className="text-gray-600 text-sm">
                  Your feedback helps us improve our services and provide a better experience for all our users. We read every submission and take your comments seriously.
                </p>
              </div>
            </div>
          </div>
